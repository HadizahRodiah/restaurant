...
const Good= () => {
  ...
  return (
    <div className='w-full p-10 bg-white flex flex-col flex-wrap justify-between py-20 md:flex-row' id='order'>
 ...
 <span className=' font-bold text-5xl text-transparent bg-clip-text bg-gradient-to-r from-yellow-700 to-green-900'>Order</span> <span className='text-3xl text-yellow-900'>Now!</span>   </div>
  ...
  {order.map(order=>(
              <div className="card w-80 mb-10 shadow-lg" key={order.id}>
